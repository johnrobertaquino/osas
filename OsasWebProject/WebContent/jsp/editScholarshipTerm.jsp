...
<link rel="stylesheet" type="text/css" href="css/editScholarshipTerm.css">
<link rel="shortcut icon" type="image/png" href="images/PUPLogo.png" />
<script type="text/javascript" src="js/jquery-3.4.1.js"></script>
<script type="text/javascript" src="js/jquery-ui/jquery-ui.js"></script>
<script type="text/javascript" src="js/common.js"></script>
<script type="text/javascript" src="js/editScholarshipTerm.js"></script>
</head>
<body>
<div id="header">
...
<div id="contentBody">
	<div id="editScholarshipTermContentBody" class="featureContent">
		<div id="contentBodyLeftPane">
			<div id="icon"><img src="images/editAccount.png"/></div>
			<div id="title">EDIT SCHOLARSHIP TERM</div>
		</div>
		<div id="contentBodyRightPane">
			<div id="rightPaneContentHolder">
				<form class="editScholarshipTermContent" id="editScholarshipTermForm" action="editScholarshipTerm" method="POST">
    				...
    				<div class="rightPaneElement withTitle">
    					<span>Active</span>
    					<div><input id="active" name="active" type="text" value="${scholarshipTerm.active}"></div>
    				</div>

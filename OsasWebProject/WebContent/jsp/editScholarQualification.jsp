...
<link rel="stylesheet" type="text/css" href="css/editScholarQualification.css?${dateTimeStamp}">
...
<script type="text/javascript" src="js/editScholarQualification.js?${dateTimeStamp}"></script>
</head>
<body>
<div id="header">

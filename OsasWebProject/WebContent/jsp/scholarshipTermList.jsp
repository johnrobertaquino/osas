...
<link rel="stylesheet" type="text/css" href="css/scholarshipTermList.css">
<link rel="shortcut icon" type="image/png" href="images/PUPLogo.png" />
<script type="text/javascript" src="js/jquery-3.4.1.js"></script>
<script type="text/javascript" src="js/common.js"></script>
<script type="text/javascript" src="js/scholarshipTermList.js"></script>
</head>
<body>
<div id="header">
...
<div id="contentBody">
	<form id="editScholarshipTermForm" action="displayEditScholarshipTerm" method="POST">
  		<input type="hidden" id="scholarshipTermId" name="scholarshipTermId" />
	</form>
	<div id="scholarshipTermListContentBody" class="featureContent" >
	<div id="contentBodyHolder">
		<div id="contentBodyLeftPane">
			<div id="icon"><img src="images/editAccount.png"/></div>
			<div id="title">LIST OF SCHOLARSHIP TERM</div>
		</div>
		<div id="contentBodyRightPane">
			<div id="searchScholarshipTerm">
				<img src="images/Search_Magnifying_Glass_Find-512.png">
				<form action="searchScholarshipTerm" method="POST" id="searchScholarshipTermForm">
					<input type="text" id="scholarshipTermSearchText" name="scholarshipTermSearchText" placeholder="Search Scholarship Term">
				</form>
				<div class="button" id="searchScholarshipTermButton">SEARCH</div>
				<div class="button" id="addScholarshipTermButton">ADD SCHOALRSHIP TERM</div>
    			<div style="clear:both"></div>
			</div>
			<table>
				<tr>
					<th>Scholarship Term name</th>
					<th>Start Date</th>
					<th>End Date</th>
					<th>Active</th>
				</tr>
				<s:iterator value="scholarshipTermList" status="rowStatus" var="scholarshipTerm">
					<tr <s:if test="#rowStatus.odd == true ">class="odd"</s:if>>
						<td><s:property value="scholarshipTermName" /></td>
						...
						<td>
							<div class="w3-dropdown-click tableMenu">
  								...
  								<div class="tableMenuDropdown w3-dropdown-content w3-bar-block w3-border">	
	    			    			<a onclick="displayEditScholarshipTerm('<s:property value="scholarshipTermId" />')" class="w3-bar-item w3-button">Edit</a>
  								</div>
							</div>
						</td>
					</tr>
